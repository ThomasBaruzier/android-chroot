...
```bash
sudo mkdir /data/archlinux/ # stop if this errors, you probably already have a archlinux chroot on your system. if not, please stop following this tutorial, this shouldn't happen
